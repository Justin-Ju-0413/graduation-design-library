...
ALL_FIGURES = [
    ...
    ('fig_verification_chain.png', 'Verification Flow Chain from RTL Simulation to FPGA Board Test', 5.5),
    ('fig_fpga_board.jpg', 'Davinci Pro A7-100T FPGA Development Board', 5.0),
    ('fig_ila_pc_trace.png', 'ILA Capture: hello_e203 Boot Sequence (PC Progression)', 5.5),
    ('fig_ila_nice_activity.png', 'ILA Capture: NICE CNN Accelerator Instruction Execution', 5.5),
    ('fig_speedup_bar.png', 'CNN Accelerator Performance Speedup (5.28× over CPU-only)', 4.5),
    ('fig_utilization.png', 'FPGA Resource Utilization (Post-Implementation)', 5.0),
    ('fig_resource_pie.png', 'FPGA Resource Utilization Distribution (Post-Placement)', 4.5),
    ('fig_timing.png', 'Timing Closure Across FPGA Build Configurations', 5.5),
