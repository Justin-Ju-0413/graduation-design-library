...
The ILA capture (Figure~\ref{fig:4_2}) confirmed that the CPU executed through all NICE instructions and reached the program’s completion loop. Key probe values are listed in Table~\ref{tab:4_5}:
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{figures/fig_speedup_bar.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.70\textwidth]{figures/fig_resource_pie.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{figures/fig_utilization.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.80\textwidth]{figures/fig_timing.png}
