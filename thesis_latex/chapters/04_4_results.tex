...
The complete LeNet-5 firmware (v8) was deployed on the FPGA board using the \texttt{cnn\_sysclk\_ila} build mode. Two issues were identified and resolved during iterative board testing:
