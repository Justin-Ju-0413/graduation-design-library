...
This project has successfully designed, implemented, and validated a lightweight CNN accelerator integrated with a RISC-V E203 processor~\cite{NUCLEI_E203} through the NICE custom instruction interface~\cite{RISCV_UNPRIV_SPEC} on an FPGA platform. The principal contributions are:
